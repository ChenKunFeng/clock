...
var DatePicker = function DatePicker(p) {
  ...
  var pickerValue = (0, _react.useMemo)(function () {
    return (0, _datePickerUtils.convertDateToStringArray)(value);
  }, [value]);
  var onConfirm = (0, _react.useCallback)(function (val) {
    setValue((0, _datePickerUtils.convertStringArrayToDate)(val));
  }, [setValue]);
  var onSelect = (0, _react.useCallback)(function (val) {
    var _a;

    var date = (0, _datePickerUtils.convertStringArrayToDate)(val);
  ...
  return (0, _nativeProps.withNativeProps)(props, /*#__PURE__*/_react["default"].createElement(_picker["default"], {
    columns: function columns(selected) {
      return (0, _datePickerUtils.generateDatePickerColumns)(selected, props.min, props.max, props.precision, props.renderLabel);
    },
    value: pickerValue,
    ...
    return (_a = props.children) === null || _a === void 0 ? void 0 : _a.call(props, (0, _datePickerUtils.convertStringArrayToDate)(items.map(function (item) {
