...
var createPxReplace = function createPxReplace(rootValue, identifier, unitPrecision, minPixelValue) {
  return function (m, $1, $2, doubleRem) {
    if (!$1) return m;
    ...
    var double = doubleRem === true ? 2 : 1;
    var fixedVal = toFixed(pixels * double / baseValue, unitPrecision);
    return fixedVal + 'rem';
  };
};
...
exports.default = _postcss2.default.plugin('postcss-plugin-px2rem', function (options) {
  ...
  return function (css) {
    css.walkDecls(function (decl, i) {
      ...
      var doubleRem = blacklistedSelector(opts.selectorDoubleRemList, _decl.parent.selector);
      var value = _decl.value.replace(pxRegex, function (m, $1, $2) {
        return pxReplace(m, $1, $2, doubleRem);
      });
