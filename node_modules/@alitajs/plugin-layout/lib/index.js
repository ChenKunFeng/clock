...
var _default = api => {
  var _api$userConfig, _api$userConfig$layou;
  ...
  if (!((_api$userConfig = api.userConfig) === null || _api$userConfig === void 0 ? void 0 : (_api$userConfig$layou = _api$userConfig.layout) === null || _api$userConfig$layou === void 0 ? void 0 : _api$userConfig$layou.useCustomLayout)) {
  ...
  api.addUmiExports(() => [{
    specifiers: [{
      local: 'default',
      exported: 'PluginLayout'
    }],
    source: _umi().utils.winPath((0, _path().join)(api.paths.absTmpPath || '', DIR_NAME, 'Layout.tsx'))
  }]);
